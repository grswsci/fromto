...
gse2url = function(gse_id, series = 'matrix') {
  if(nchar(fromto::strsplit_fromto(gse_id,"-",1)) == 8){
    #gse_uid = gsub("\\d{1,3}$", "nnn", gse_id, perl = TRUE)
    gse_uid = paste0(substr(fromto::strsplit_fromto(gse_id,"-",1),1,5),"nnn")
  }else if(nchar(fromto::strsplit_fromto(gse_id,"-",1)) == 9){
    #gse_uid = gsub("\\d{1,3}$", "nnn", gse_id, perl = TRUE)
    gse_uid = paste0(substr(fromto::strsplit_fromto(gse_id,"-",1),1,6),"nnn")
  }else if(nchar(fromto::strsplit_fromto(gse_id,"-",1)) == 7){
    #gse_uid = gsub("\\d{1,3}$", "nnn", gse_id, perl = TRUE)
    gse_uid = paste0(substr(fromto::strsplit_fromto(gse_id,"-",1),1,4),"nnn")
  }
